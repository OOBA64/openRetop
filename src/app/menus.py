...
def build_menu_bar(app: object) -> Menu:
    ...
    app.view_menu.add_command(label="Show All Objects", command=app.show_all_scene_objects)
    app.view_menu.add_command(label="Isolate Selected", command=app.hide_unselected_scene_objects)
    app.view_menu.add_command(
